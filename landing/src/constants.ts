...
const GH_RELEASES = 'https://github.com/nguyenquy0710/zalo-crm/releases';
...
/** Trang GitHub repo */
export const GITHUB_URL = 'https://github.com/nguyenquy0710/zalo-crm';

/** Windows - NSIS installer */
export const DOWNLOAD_FILENAME      = `ZaloCRM-Setup-${APP_VERSION}.exe`;
export const DOWNLOAD_URL           = `${GH_LATEST}/${DOWNLOAD_FILENAME}`;

/** macOS - Apple Silicon (M1/M2/M3) */
export const DOWNLOAD_FILENAME_MAC_ARM64 = `ZaloCRM-${APP_VERSION}-arm64.dmg`;
export const DOWNLOAD_URL_MAC_ARM64      = `${GH_LATEST}/${DOWNLOAD_FILENAME_MAC_ARM64}`;

/** macOS - Intel (x64) */
export const DOWNLOAD_FILENAME_MAC_X64 = `ZaloCRM-${APP_VERSION}.dmg`;
export const DOWNLOAD_URL_MAC_X64      = `${GH_LATEST}/${DOWNLOAD_FILENAME_MAC_X64}`;

/** Linux - AppImage (x64, works on any distro) */
export const DOWNLOAD_FILENAME_LINUX   = `ZaloCRM-${APP_VERSION}.AppImage`;
export const DOWNLOAD_URL_LINUX         = `${GH_LATEST}/${DOWNLOAD_FILENAME_LINUX}`;

/** Linux - .deb (Ubuntu/Debian) */
export const DOWNLOAD_FILENAME_LINUX_DEB = `ZaloCRM_${APP_VERSION}_amd64.deb`;
